                    ...
                    <div class="p-6">
                        <form action="{{ route('film.update', $film->id) }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div>
                                    <select name="genre_id" id="genre_id"
                                        ...
                                        @foreach ($genre as $data)
                                            <option value="{{ $data->id }}" {{ old('genre_id', $film->genre_id) == $data->id ? 'selected' : '' }}>
                                                {{ $data->nama_genre }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                                ...
                                <div>
                                    <div class="relative">
                                        ...
                                        <input type="number" id="tahun_rilis" name="tahun_rilis" value="{{ old('tahun_rilis', $film->tahun_rilis) }}" 
                            ...
                            <div class="form-group">
                                ...
                                @enderror
                                @if ($film  ->image)
                                    <img src="{{ Storage::url($film ->image) }}" alt="{{ $film ->nama }}" width="100" class="mt-2">
                                @endif
                            </div>
                            <!-- Buttons -->
